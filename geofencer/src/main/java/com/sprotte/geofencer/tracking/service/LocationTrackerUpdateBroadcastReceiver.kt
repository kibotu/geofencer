package com.sprotte.geofencer.tracking.service
...
import com.sprotte.geofencer.utils.enqueueOneTimeLocationUpdateWorkRequest
...
class LocationTrackerUpdateBroadcastReceiver : BroadcastReceiver() {
    ...
    companion object {
        internal const val ACTION_PROCESS_UPDATES =
            "com.sprotte.geofencer.tracking.service.ACTION_PROCESS_UPDATES"
    }
}
