...
import com.sprotte.geofencer.demo.databinding.FragmentMapBinding
import com.sprotte.geofencer.demo.misc.hideKeyboard
import com.sprotte.geofencer.demo.misc.requestFocusWithKeyboard
import com.sprotte.geofencer.demo.misc.showGeofenceInMap
import com.sprotte.geofencer.geofencer.Geofencer
import com.sprotte.geofencer.geofencer.models.Geofence
import com.sprotte.geofencer.tracking.LocationTracker
import com.sprotte.geofencer.utils.showTwoButtonDialog
        ...
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()) { permissions ->
            ...
            if (fineGranted || coarseGranted) {
                ...
                if (shouldShowRationale) {
                    requireActivity().showTwoButtonDialog(getString(com.sprotte.geofencer.R.string.dialog_rationale_coarse_location)) {
